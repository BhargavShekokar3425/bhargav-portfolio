  ...
  return <section id="skills" ref={sectionRef} className="py-20">
      <div className="container mx-auto px-4">
        ...
        <div className="grid-skills">
          {skillCategories.map((category, index) => <Card key={category.title} className="card-hover p-6 animate-scale-in" style={{
        ...
        <div className="mt-16 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {["Python", "C++", "JavaScript", "React", "Node.js", "PyTorch", "TensorFlow", "Flask", "FastAPI", "SQL", "MongoDB", "Docker", "AWS", "Git", "Linux", "Redis", "PostgreSQL", "REST APIs"].map((tech, index) => <span key={tech} className="px-4 py-2 bg-secondary rounded-full text-sm font-medium hover:bg-accent hover:text-accent-foreground transition-all duration-300 cursor-default animate-fade-in" style={{
